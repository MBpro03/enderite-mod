...
public class ModItems {
    ...
    public static final Item ENDERITE_SWORD =
        new SwordItem(ModToolMaterial.ENDERITE, 3, -2.4f, new Item.Settings());

    public static final Item ENDERITE_HELMET =
        new ArmorItem(ModArmorMaterial.ENDERITE, ArmorItem.Type.HELMET, new Item.Settings());
    public static final Item ENDERITE_CHESTPLATE =
        new ArmorItem(ModArmorMaterial.ENDERITE, ArmorItem.Type.CHESTPLATE, new Item.Settings());
    public static final Item ENDERITE_LEGGINGS =
        new ArmorItem(ModArmorMaterial.ENDERITE, ArmorItem.Type.LEGGINGS, new Item.Settings());
    public static final Item ENDERITE_BOOTS =
        new ArmorItem(ModArmorMaterial.ENDERITE, ArmorItem.Type.BOOTS, new Item.Settings());
